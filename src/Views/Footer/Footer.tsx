...
const Footer = () => {
  ...
  return (
    <>
      <h1 className="p-4 hover:cursor-pointer" onClick={() => dispatch(increment())}>increment</h1>
      <h3>{count}</h3>
      <h2 className="p-4 hover:cursor-pointer" onClick={() => dispatch((decrement()))}>decrement</h2>
